...
const device = awsIot.device({
  keyPath: path.resolve(__dirname, './AWS/certs/private.pem.key'),
  certPath: path.resolve(__dirname, './AWS/certs/certificate.pem.crt'),
  caPath: path.resolve(__dirname, './AWS/certs/AmazonRootCA1.pem'),
  clientId: "Web",
